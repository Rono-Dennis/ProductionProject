...
@Entity
@Table(name = "data_updates", schema = "public")
public class DataUpdateSettings {
    ...
    @Column(name = "update_condition")
    private String updateCondition;     //allow WHERE in the column but be sure to remove it before using

    @Column(name = "row_identifiers")
    ...
    @Column(name = "dest_datasource")
    private String destDatasource;          //INTEG,ABACUS,MS

    @Column(name = "dest_table")
    private String destTable;          //INTEG,ABACUS,MS
    ...
    /**
     * @return String return the updateType
     */
    ...
    /**
     * @return String return the rowIdentifiers
     */
