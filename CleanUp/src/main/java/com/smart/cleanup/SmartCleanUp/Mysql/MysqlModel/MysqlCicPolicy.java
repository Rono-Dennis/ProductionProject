package com.smart.cleanup.SmartCleanUp.Mysql.MysqlModel;
...
@Data
@Entity
@Table(name = "CIC_POLICY", schema = "SMART_CLEAN_UP", catalog = "",
        uniqueConstraints = {@UniqueConstraint(columnNames = {"CLN_POL_CODE", "REC_ID"})})
public class MysqlCicPolicy {
    @Id
